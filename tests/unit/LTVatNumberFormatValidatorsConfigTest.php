...
namespace rocketfellows\LTVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\LTVatNumberFormatValidatorsConfig\LTVatNumberFormatValidatorsConfig;

class LTVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = LTVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = LTVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::LT(), $config->getCountry());
    }
